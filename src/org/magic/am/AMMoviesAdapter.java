...
public class AMMoviesAdapter extends ArrayAdapter<String>{
	  ...
	  public AMMoviesAdapter(Context context, String[] values) {
	  ...
	  public View getView(int position, View convertView, ViewGroup parent) {
	    ...
	    View view = inflater.inflate(R.layout.actormovies_list, parent, false);
	    TextView textview = (TextView) view.findViewById(R.id.movieTitleOfActor);
